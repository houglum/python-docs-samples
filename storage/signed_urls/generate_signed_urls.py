...
class AddressingStyle(object):
    # Bucket supplied in the URI path, e.g. storage.googleapis.com/bucket/obj
    PATH = 'path'
    # Bucket supplied in the URI host, e.g. bucket.storage.googleapis.com/obj
    VIRTUAL_HOSTED = 'virtual_hosted'

    @classmethod
    def default(cls):
        # TODO: Change this once we want the default to be VIRTUAL_HOSTED.
        return cls.PATH
...
def generate_signed_url(service_account_file, bucket_name, object_name,
    ...
    if addressing_style == AddressingStyle.PATH:
        canonical_uri = '/{}{}'.format(bucket_name, canonical_uri)
    ...
    if addressing_style == AddressingStyle.VIRTUAL_HOSTED:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--addressing_style',
        help='Style of URL to generate.',
        default=AddressingStyle.default(),
        choices=[AddressingStyle.PATH, AddressingStyle.VIRTUAL_HOSTED])
    parser.add_argument(
        '--subresource',
        default=None,
